package br.com.rogrs.webchat.controller;
...
import br.com.rogrs.webchat.model.ChatMessage;
...
public class WebsocketEndpointIT {
    ...
    private static final String SEND_CREATE_BOARD_ENDPOINT = "/channel/public";
    ...
    private static final String SUBSCRIBE_MOVE_ENDPOINT = "/channel/move/";
    ...
    public void testCreateGameEndpoint() throws URISyntaxException, InterruptedException, ExecutionException, TimeoutException {
        ...
        ChatMessage gameState = completableFuture.get(10, SECONDS);
    ...
    public void testMakeMoveEndpoint() throws InterruptedException, ExecutionException, TimeoutException {
      ...
      //S  stompSession.send(SEND_MOVE_ENDPOINT + uuid, new Move(1, 0));
        ChatMessage gameStateAfterMove = completableFuture.get(5, SECONDS);
